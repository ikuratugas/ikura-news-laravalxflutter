...
<body>
  ...
  <div class="preview">
    ...
    <input placeholder="Masukkan Judul Berita" value="<?php echo e(old('name')); ?>" type="text" name="title" id="">
    <br>
    <textarea placeholder="Masukkan Deskripsi Berita" name="description" id="" cols="100" rows="30"><?php echo e(old('description')); ?></textarea>
    <br>
